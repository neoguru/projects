package com.axboot.freelancer.domain.init;

import com.axboot.freelancer.domain.code.CommonCode;
import com.axboot.freelancer.domain.code.CommonCodeService;
import com.axboot.freelancer.domain.program.Program;
import com.axboot.freelancer.domain.program.ProgramService;
import com.axboot.freelancer.domain.program.menu.Menu;
import com.axboot.freelancer.domain.program.menu.MenuService;
import com.axboot.freelancer.domain.user.User;
import com.axboot.freelancer.domain.user.UserService;
import com.axboot.freelancer.domain.user.auth.UserAuth;
import com.axboot.freelancer.domain.user.auth.UserAuthService;
import com.axboot.freelancer.domain.user.auth.menu.AuthGroupMenu;
import com.axboot.freelancer.domain.user.auth.menu.AuthGroupMenuService;
import com.axboot.freelancer.domain.user.role.UserRole;
import com.axboot.freelancer.domain.user.role.UserRoleService;
