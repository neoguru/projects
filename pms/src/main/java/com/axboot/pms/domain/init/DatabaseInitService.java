package com.axboot.pms.domain.init;

import com.axboot.pms.domain.code.CommonCode;
import com.axboot.pms.domain.code.CommonCodeService;
import com.axboot.pms.domain.program.Program;
import com.axboot.pms.domain.program.ProgramService;
import com.axboot.pms.domain.program.menu.Menu;
import com.axboot.pms.domain.program.menu.MenuService;
import com.axboot.pms.domain.user.User;
import com.axboot.pms.domain.user.UserService;
import com.axboot.pms.domain.user.auth.UserAuth;
import com.axboot.pms.domain.user.auth.UserAuthService;
import com.axboot.pms.domain.user.auth.menu.AuthGroupMenu;
import com.axboot.pms.domain.user.auth.menu.AuthGroupMenuService;
import com.axboot.pms.domain.user.role.UserRole;
import com.axboot.pms.domain.user.role.UserRoleService;
