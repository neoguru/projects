...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "noPartner", label: COL("partner.noPartner"), width: 80, align: "center"},
                {key: "nmPartner", label: COL("partner.nmPartner"), width: 160, align: "center"},
                {key: "typePartner", label: COL("partner.typePartner"), width: 100, align: "center",  formatter: function () {                	
                    return parent.COMMON_CODE["PARTNER_TYPE"].map[this.value]
            		}},
                {key: "nmCeo", label: COL("nmCeo"), width: 90, align: "center"}
            ],
            body: {
                onClick: function () {
