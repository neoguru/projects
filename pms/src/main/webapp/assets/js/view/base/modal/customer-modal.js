...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "noCustomer", label: COL("noCustomer"), width: 80, align: "center"},
                {key: "nmCustomer", label: COL("nmCustomer"), width: 160, align: "center"},
                {key: "nmCeo", label: COL("nmCeo"), width: 90, align: "center"},
                {key: "noTel", label: COL("noTel"), width: 90, align: "center", formatter: "phone"}
            ],
            body: {
                onClick: function () {
