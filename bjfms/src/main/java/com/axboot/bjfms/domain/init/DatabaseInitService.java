package com.axboot.bjfms.domain.init;

import com.axboot.bjfms.domain.code.CommonCode;
import com.axboot.bjfms.domain.code.CommonCodeService;
...
import com.axboot.bjfms.domain.user.auth.UserAuth;
import com.axboot.bjfms.domain.user.auth.UserAuthService;
...
import com.axboot.bjfms.domain.user.role.UserRole;
import com.axboot.bjfms.domain.user.role.UserRoleService;
