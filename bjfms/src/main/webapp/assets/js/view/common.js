...
function getLastDate(date){
    /* 
	    ****************************************************************************************************
	    *  함수설명: date(yyyy-mm-dd)를 입력받아 해당월의 말일을 YYYY-MM-DD형태로 return
	    *
	    * 사용예
	    ****************************************************************************************************
	    */
...
function getNextLastDate(date){
    /* 
	    ****************************************************************************************************
	    *  함수설명: date(yyyy-mm-dd)를 입력받아 다음달 말일을 YYYY-MM-DD형태로 return
	    *
	    * 사용예
	    ****************************************************************************************************
	    */
...
function getMMDate(date){
	...
	var mmDate = new Date(year, month , day);
	return mmDate.toISOString().substring(0, 10);
}

function getLastDay(year, month){
    /* 
	    ****************************************************************************************************
	    *  함수설명: 년, 월을 입력받아 해당월의 말일을 return
	    * month는 
	    * 사용예
	    ****************************************************************************************************
	    */
...
function getDtSales(type, dtStart){
    /* 
	    ****************************************************************************************************
	    *  함수설명: 시작일자(투입일)와 매출타입을 받아 계산서발행일을 return
	    *
	    * 사용예
	    ****************************************************************************************************
	    */
	var date = new Date(dtStart);
...
function getMM(dtStart, dtEnd){
	...
	if ((sdd == 1) && (edd == 15)) {
		cdd = 0.5;
	} else if ((sdd == 16) && (edd == getLastDay(eyy, emm))) {
		cdd = 0.5;
	} else if ((sdd == 1) && (edd == getLastDay(eyy, emm))) {
		cdd = 1;
	} else if ((sdd - edd) >= 1){
		if ((sdd - edd) == 1) {
			cdd = 0;
		} else if (smm == emm){
			cdd = (((edd - sdd) +1) / getLastDay(syy, smm));
		} else {
			cmm = cmm -1;
			cdd = (((getLastDay(syy, smm) - sdd) + 1)/ getLastDay(syy, smm)) + (edd / getLastDay(eyy, emm));
		}
	} else {
		cdd = ((edd - (sdd -1)) / getLastDay(eyy, emm));
	}
	cmm = cmm + cdd;
//	cmm = cmm.toFixed(2);
	return cmm;
