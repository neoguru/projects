...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/reports/employee_report_modal.js' />"></script>
    </jsp:attribute>
    ...
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="vertical">
            <ax:split-panel width="*" style="padding-right: 0px;">            
            	...
            	<div id="report">         
                	<iframe id="reportView"  width="100%", height="720px" scrolling="auto"></iframe>     
