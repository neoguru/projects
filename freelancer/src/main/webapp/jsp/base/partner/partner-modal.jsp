...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/base/partner/partner-modal.js' />"></script>
    </jsp:attribute>
        ...
        <div role="page-header">
            <ax:form name="searchView0">
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='ax.admin.partner.nmPartner' width="300px">
                            <ax:input type="text" name="nmPartner" id="nmPartner" clazz="form-control" placeholder="ax.admin.input.search"/>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
