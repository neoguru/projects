...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/base/modal/customer-modal.js' />"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title">
            <i class="cqc-browser"></i>
            <ax:lang id="ax.admin.customer.modal.title"/>
        </h1>
    </jsp:attribute>
    <jsp:body>
        <ax:page-buttons>
        ...
        <div role="page-header">
            <ax:form name="searchView0">
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='ax.admin.nmCustomer' width="300px">
                            <ax:input type="text" name="nmCustomer" id="nmCustomer" clazz="form-control" placeholder="ax.admin.input.search"/>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
