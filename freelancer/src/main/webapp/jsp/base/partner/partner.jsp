            					...
            					<ax:td label="ax.admin.nmPartner" width="240px">
                      			...
                      			<ax:td label="ax.admin.noLicense" width="240px">
                            		<div class="input-group">
                                		<input type="text" name="noLicense" data-ax-path="noLicense" class="form-control" data-ax5formatter="bizno" data-ax-validate="required" title="사업자등록번호" style="text-align:center;border-color:Orange;"/>                                	
                            		</div>
                            	</ax:td>
