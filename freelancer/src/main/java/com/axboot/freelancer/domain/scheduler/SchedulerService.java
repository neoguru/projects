package com.axboot.freelancer.domain.scheduler;

import com.axboot.freelancer.domain.user.User;
import com.axboot.freelancer.domain.BaseService;
import com.axboot.freelancer.domain.scheduler.repeat.SchedulerRepeatService;
...
//   	 	Integer noEmployee = requestParams.getInt("noEmployee");
        ...
        if (isNotEmpty(userCd))
        	builder.and(qScheduler.userCd.eq(userCd));
/*
        if (noEmployee > 0)
