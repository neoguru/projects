package com.axboot.freelancer.domain.scheduler.repeat;

import com.axboot.freelancer.domain.user.User;
import com.axboot.freelancer.domain.BaseService;
import com.axboot.freelancer.domain.scheduler.Scheduler;
import com.axboot.freelancer.domain.scheduler.SchedulerRepository;
import com.axboot.freelancer.domain.scheduler.SchedulerService;
import com.axboot.freelancer.domain.scheduler.repeat.change.SchedulerRepeatChange;
import com.axboot.freelancer.domain.scheduler.repeat.change.SchedulerRepeatChangeService;
...
//   	 	Integer noEmployee = requestParams.getInt("noEmployee");
        ...
        if (isNotEmpty(userCd)) {
        	builder.and(qSchedulerRepeat.scheduler.userCd.eq(userCd));
        }
        /*
        if (noEmployee > 0)
