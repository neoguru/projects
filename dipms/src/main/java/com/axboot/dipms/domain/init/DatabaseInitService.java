package com.axboot.dipms.domain.init;

import com.axboot.dipms.domain.code.CommonCode;
import com.axboot.dipms.domain.code.CommonCodeService;
import com.axboot.dipms.domain.program.Program;
import com.axboot.dipms.domain.program.ProgramService;
import com.axboot.dipms.domain.program.menu.Menu;
import com.axboot.dipms.domain.program.menu.MenuService;
import com.axboot.dipms.domain.user.User;
import com.axboot.dipms.domain.user.UserService;
import com.axboot.dipms.domain.user.auth.UserAuth;
import com.axboot.dipms.domain.user.auth.UserAuthService;
import com.axboot.dipms.domain.user.auth.menu.AuthGroupMenu;
import com.axboot.dipms.domain.user.auth.menu.AuthGroupMenuService;
import com.axboot.dipms.domain.user.role.UserRole;
import com.axboot.dipms.domain.user.role.UserRoleService;
